...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 10, 2024 at 08:07 AM
...
(7, 'IT Staff', 'it', 'U2FtcGxlQDEyMw==', '#f0f8ff', '5', '2'),
(8, 'd', 'd', 'ZA==', '#ffe135', '5', '4'),
...
(26, 'new User', 'newuser', 'bmV3dXNlcg==', '#ffe135', '13', '2');
...
(27, 3, 'a', 'a', NULL, 5, 1, 1, '2024-01-03 03:35:00', '2024-01-06 08:59:00'),
(29, 2, 'this is sample', 'this is the new sample', NULL, 1, 1, 3, '2024-01-04 11:48:00', '2024-01-04 11:48:00'),
(30, 11, 'Change Password', 'This is sample only', 'this is the remarks', 1, 3, 0, '2024-01-09 09:20:00', '2024-01-09 10:25:00'),
(31, 3, 'sample', 'sss', NULL, 1, 4, 1, '2024-01-10 09:54:00', '2024-01-11 09:55:00'),
(32, 5, 'sample', 'ss', 'Need a conformation\nNew ', 2, 4, 1, '2024-01-09 10:36:00', '2024-01-09 10:36:00'),
(33, 1, 'ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss', 'ssssssssssssssssss\ns\ns\ns\ns\ns\n\ns', NULL, 1, 4, 2, '2024-01-10 12:03:00', '2024-01-11 12:03:00');
...
--
ALTER TABLE `columntable`
  MODIFY `columnId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
